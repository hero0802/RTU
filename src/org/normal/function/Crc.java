...
static	byte[] crc16_tab_h = { (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0,
	...
	public static byte [] getCrc16M(byte []bytes) {
		
		int i = calcCrc16(bytes,0,bytes.length-2);
		...
		String result = m.substring(2)+m.substring(0, 2);
		byte [] ret = Func.hexStringToBytes(result);
		return ret;
	}
